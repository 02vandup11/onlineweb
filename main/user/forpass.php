                                ...
                                <form action="" method="post">
                                    <div class="flex flex-col space-y-16 p-2">
                                        ...
                                        <div id="otp" class="inputs flex flex-row items-center justify-between mx-auto w-full max-w-xs"> 
                                            <input id="first" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==1) return false;" name="first" class=" w-16 h-16 flex flex-col items-center justify-center text-center px-5 outline-none rounded-xl border border-gray-200 text-lg bg-white focus:bg-gray-50 focus:ring-1 ring-amber-700" type="text" id="first"> 
                                            <input id="second" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==1) return false;" name="second" class=" w-16 h-16 flex flex-col items-center justify-center text-center px-5 outline-none rounded-xl border border-gray-200 text-lg bg-white focus:bg-gray-50 focus:ring-1 ring-amber-700" type="text" id="second"> 
                                            <input id="third" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==1) return false;" name="third" class=" w-16 h-16 flex flex-col items-center justify-center text-center px-5 outline-none rounded-xl border border-gray-200 text-lg bg-white focus:bg-gray-50 focus:ring-1 ring-amber-700" type="text" id="third"> 
                                            <input id="fourth" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==1) return false;" name="fourth" class=" w-16 h-16 flex flex-col items-center justify-center text-center px-5 outline-none rounded-xl border border-gray-200 text-lg bg-white focus:bg-gray-50 focus:ring-1 ring-amber-700" type="text" id="fourth"> 
                                            </div> 
                                                ...
                                                <div class="flex flex-col space-y-5">
                                                    <div>
                                                        <button type="button" id="verifyOtp" class="flex flex-row items-center justify-center text-center w-full border rounded-xl outline-none py-4 bg-amber-700 border-none text-white text-sm shadow-sm">
                                                        Verify OTP
                                                        </button>
                                                    </div>
                    ...
                    <div id="cardBackground2" class="card bg-orange-800 shadow-lg w-full h-full rounded-3xl absolute transform rotate-6"></div>
                        <div id="mainContainer" class="relative w-full rounded-3xl px-6 py-4 bg-gray-100 shadow-md">
                            ...
                            <form class="mt-4 space-y-4 lg:mt-5 md:space-y-5">
                                ...
                                <button id="changepass"type="submit" class="w-full text-white bg-amber-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Reset password </button>
