              ...
              <tbody class="whitespace-nowrap divide-y">
                ...
                <tr>
                  <td class="py-6 px-4">
                    <div class="flex items-center gap-6 w-max">
                      <div class="h-36 shrink-0">
                        <img src='https://readymadeui.com/images/product3.webp' class="w-full h-full object-contain" />
                      </div>
                      <div>
                ...
                <tr>
                  <td class="py-6 px-4">
                    <div class="flex items-center gap-6 w-max">
                      <div class="h-36 shrink-0">
                        <img src='https://readymadeui.com/images/product5.webp' class="w-full h-full object-contain" />
                      </div>
                      <div>
                        <p class="text-md font-bold text-[#333]">Black T-Shirt</p>
                        <button type="button" class="mt-4 font-semibold text-red-400 text-sm">
