                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <select id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            ...
                            <option value="TV">Necklace</option>
                            <option value="PC">Earnings</option>
                            <option value="GA">Ring</option>
                            <option value="PH">Bracelet</option>
                            <option value="TV">Watch</option>
                            <option value="PC">Bangle</option>
                            <option value="GA">Jewelry Set</option>
                            <option value="PH">Oxidized Set</option>
                            <option value="PH">Hair Accessories</option>
                        </select>
                    </div>
                    <div class="col-span-2 sm:col-span-1">
